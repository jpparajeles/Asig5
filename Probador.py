...
def prueba(fun):
    ret = [(1200, 1, 1), (2000, 15, 1), (2000, 1, 32), (2000, 1, 31), (2000, 1, 30), (2000, 1, 29), (2000, 1, 28),
           ...
           (1995, 4, 31), (1995, 4, 30), (1995, 4, 29), (1995, 4, 28), (2015, 4, 20), (1996, 2, 29), (1996, 2, 28),
           (1996, 2, 20), (1900, 2, 29), (1900, 2, 28), (1900, 2, 20), (2000, 2, 29), (2000, 2, 28), (2000, 2, 20)]
    ...
    for i,elem in enumerate(ret):
        try:
            print("R{}".format(i+1))
            print("Prueba: {}".format(elem))
            print("Oraculo: {}".format(ora[i]))
            print("Result : {}".format(fun(elem))) # Si retorna
            #print("Result: ", end=" ")                # si hace print
            #fun(elem)
